...
//    let homeVM = HomeViewModel()
    ...
    public let stat1 = StatisticsModel(title: "Market Cap", value: "$12.5bn", percentageChange: 25.34)
    public let stat2 = StatisticsModel(title: "Total Volume", value: "$1.23Tr")
    public let stat3 = StatisticsModel(title: "Portfolio Value", value: "$50.4k", percentageChange: -12.34)
